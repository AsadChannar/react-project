...
function News_Blog() {
  ...
  const card12 = {
    ...
    discription: 'Baby boomers are the generation that grew up without a smartphone in their pockets or tablets on their laps so it"s understandable..'
  }
  const card13 = {
    image: card13_image,
        ...
        <Row className='text-center blogcard padding-bottom'>
          <Col>
            <div className="container">
              <Link to='/news-blog' className='m-3'><button type='button' style={{ backgroundColor: '#000000', color: '#ffffff' }}>1</button></Link>
              <Link to='/news-blog/page/2' className='m-3'><button type='button'>2</button></Link>
              ...
              <Link to='/news-blog/page/11' className='m-3'><button type='button'>11</button></Link>
              <Link to='/news-blog/page/2' className='m-3'><button type='button'> &#x203A; </button></Link>
            </div>
          </Col>
        </Row>
    </div>
