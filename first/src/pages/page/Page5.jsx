...
import card1_image from '../../component/img/Blog/page5/telemedicine-app-scaled-thegem-blog-masonry.jpg';
import card2_image from '../../component/img/Blog/page5/Project--scaled-thegem-blog-masonry.jpg';
import card3_image from '../../component/img/Blog/page5/bot-chat-scaled-thegem-blog-masonry.jpg';
import card4_image from '../../component/img/Blog/page5/app-dev-scaled-thegem-blog-masonry.jpg';
import card5_image from '../../component/img/Blog/page5/healthcare-scaled-thegem-blog-masonry.jpg';
import card6_image from '../../component/img/Blog/page5/devops-scaled-thegem-blog-masonry.jpg';
import card7_image from '../../component/img/Blog/page5/AI-scaled-thegem-blog-masonry.jpg';
import card8_image from '../../component/img/Blog/page5/natural2-scaled-thegem-blog-masonry.jpg';
import card9_image from '../../component/img/Blog/page5/telephysic-scaled-thegem-blog-masonry.jpg';
import card10_image from '../../component/img/Blog/page5/trends-for-development-scaled-thegem-blog-masonry.jpg';
import card11_image from '../../component/img/Blog/page5/devops-check-scaled-thegem-blog-masonry.jpg';
import card12_image from '../../component/img/Blog/page5/dementia-scaled-thegem-blog-masonry.jpg';
import card13_image from '../../component/img/Blog/page5/ux-ui-scaled-thegem-blog-masonry.jpg';
import card14_image from '../../component/img/Blog/page5/it-augmentation-scaled-thegem-blog-masonry.jpg';
import card15_image from '../../component/img/Blog/page5/hands-agent-client-shaking-hands-after-signed-contract-buy-new-apartment-1-1-1-scaled-thegem-blog-masonry.jpg';
        ...
        <Row className='text-center'>
          <Col>
            <div className="container">
              <a href='/news-blog/page/4' className='m-3'><button type='button'> &#x2039; </button></a>
              <a href='/news-blog' className='m-3'><button type='button'>1</button></a>
              ...
              <a href='/news-blog/page/4' className='m-3'><button type='button'>4</button></a>
              <a href='/news-blog/page/5' className='m-3'><button type='button' style={{ backgroundColor: '#000000', color: '#ffffff' }}>5</button></a>
              <a href='/news-blog/page/6' className='m-3'><button type='button'>6</button></a>
              ...
              <a href='/news-blog/page/11' className='m-3'><button type='button'>11</button></a>
              <a href='/news-blog/page/6' className='m-3'><button type='button'> &#x203A;</button></a>
            </div>
          </Col>
        </Row>
