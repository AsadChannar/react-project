                ...
                <Row>
                    <Col>
                        ...
                        <div className="featured-blog-card mb-3 card-blog text-left">
                            ...
                            <div className="padding-top container text-left">
                                <Card.Body>
                                    <Card.Title className='color-bule t-l-h'>{props.Cards.Card1.title}</Card.Title>
                    ...
                    <Col>
                        ...
                        <div className="featured-blog-card mb-3 card-blog text-left">
                            ...
                            <div className="padding-top container text-left">
                                <Card.Body>
                                    <Card.Title className='color-bule t-l-h'>{props.Cards.Card2.title}</Card.Title>
                                    <Card.Text className='padding-top'>
                    ...
                    <Col>
                        ...
                        <div className="featured-blog-card mb-3 card-blog text-left">
                            ...
                            <div className="padding-top container text-left">
                                <Card.Body>
                                    <Card.Title className='color-bule t-l-h'>{props.Cards.Card3.title}</Card.Title>
                                    <Card.Text className='padding-top'>
                ...
                <Row>
                    <Col>
                        ...
                        <div className="featured-blog-card mb-3 card-blog text-left">
                            ...
                            <div className="padding-top container text-left">
                                <Card.Body>
                                    <Card.Title className='color-bule t-l-h'>{props.Cards.Card4.title}</Card.Title>
                                    <Card.Text className='padding-top'>
                    ...
                    <Col>
                        ...
                        <div className="featured-blog-card mb-3 card-blog text-left">
                            ...
                            <div className="padding-top container text-left">
                                <Card.Body>
                                    <Card.Title className='color-bule t-l-h'>{props.Cards.Card5.title}</Card.Title>
                                    <Card.Text className='padding-top'>
                    ...
                    <Col>
                        ...
                        <div className="featured-blog-card mb-3 card-blog text-left">
                            ...
                            <div className="padding-top container text-left">
                                <Card.Body>
                                    <Card.Title className='color-bule t-l-h'>{props.Cards.Card6.title}</Card.Title>
                                    <Card.Text className='padding-top'>
                ...
                <Row>
                    <Col>
                        ...
                        <div className="featured-blog-card mb-3 card-blog text-left">
                            ...
                            <div className="padding-top container text-left">
                                <Card.Body>
                                    <Card.Title className='color-bule t-l-h'>{props.Cards.Card7.title}</Card.Title>
                                    <Card.Text className='padding-top'>
                    ...
                    <Col>
                        ...
                        <div className="featured-blog-card mb-3 card-blog text-left">
                            ...
                            <div className="padding-top container text-left">
                                <Card.Body>
                                    <Card.Title className='color-bule t-l-h'>{props.Cards.Card8.title}</Card.Title>
                                    <Card.Text className='padding-top'>
                    ...
                    <Col>
                        ...
                        <div className="featured-blog-card mb-3 card-blog text-left">
                            ...
                            <div className="padding-top container text-left">
                                <Card.Body>
                                    <Card.Title className='color-bule t-l-h'>{props.Cards.Card9.title}</Card.Title>
                                    <Card.Text className='padding-top'>
                ...
                <Row>
                    <Col>
                        ...
                        <div className="featured-blog-card mb-3 card-blog text-left">
                            ...
                            <div className="padding-top container text-left">
                                <Card.Body>
                                    <Card.Title className='color-bule t-l-h'>{props.Cards.Card10.title}</Card.Title>
                                    <Card.Text className='padding-top'>
                    ...
                    <Col>
                        ...
                        <div className="featured-blog-card mb-3 card-blog text-left">
                            ...
                            <div className="padding-top container text-left">
                                <Card.Body>
                                    <Card.Title className='color-bule t-l-h'>{props.Cards.Card11.title}</Card.Title>
                                    <Card.Text className='padding-top'>
                    ...
                    <Col>
                        ...
                        <div className="featured-blog-card mb-3 card-blog text-left">
                            ...
                            <div className="padding-top container text-left">
                                <Card.Body>
                                    <Card.Title className='color-bule t-l-h'>{props.Cards.Card12.title}</Card.Title>
                                    <Card.Text className='padding-top'>
                ...
                <Row>
                    <Col>
                        ...
                        <div className="featured-blog-card mb-3 card-blog text-left">
                            ...
                            <div className="padding-top container text-left">
                                <Card.Body>
                                    <Card.Title className='color-bule t-l-h'>{props.Cards.Card13.title}</Card.Title>
                                    <Card.Text className='padding-top'>
                    ...
                    <Col>
                        ...
                        <div className="featured-blog-card mb-3 card-blog text-left">
                            ...
                            <div className="padding-top container text-left">
                                <Card.Body>
                                    <Card.Title className='color-bule t-l-h'>{props.Cards.Card14.title}</Card.Title>
                                    <Card.Text className='padding-top'>
                    ...
                    <Col>
                        ...
                        <div className="featured-blog-card mb-3 card-blog text-left">
                            ...
                            <div className="padding-top container text-left">
                                <Card.Body>
                                    <Card.Title className='color-bule t-l-h'>{props.Cards.Card15.title}</Card.Title>
                                    <Card.Text className='padding-top'>
